...
class CameraPage4 extends StatefulWidget {
  static String routeName = "/camera4";
  final int moduleEntryId;

  const CameraPage4({Key key, this.moduleEntryId}) : super(key: key);
  @override
  _CameraPage4State createState() => _CameraPage4State();
}
...
class _CameraPage4State extends State<CameraPage4>
